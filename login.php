...
<body class="bg-body-tertiary">
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
     ...
     <div class="col-md-6 container-sm "style="padding:3rem 5rem;margin-top:2rem;backdrop-filter: blur(50px);border-radius:15px;background-color:#e1e9f0; ">
            ...
            <p style="color:#5c5c5c">Please provide your crecedentials.</p>
            <form class="row g-3" name="checkoutform" action="./loginLogic.php" method="POST">
                ...
                <br><br>
                <div class="col-12">
                   <button id="submitform" type="submit" name="submit" class="btn addtocart" style="font-size:1.2rem;width:100%">  Login</button></div> 
                  </div>
              </form>
      </div>
</div>
